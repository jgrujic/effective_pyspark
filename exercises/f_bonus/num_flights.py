"""
In this module, some of optional exercises in the slide deck are answered.
In order not to do the fairly expensive generation of the flights360, it is
stored in a previous step and reused here. This allows for a much easier reuse
of the flights360 dataset.
"""
...
data_location = Path(__file__).parents[2] / "data" / "business_zone" / "flights360"
frame = spark.read.parquet(str(data_location))
